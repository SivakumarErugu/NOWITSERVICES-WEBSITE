...
export default function OrganizationForm() {
  ...
  return (
    <div className="min-h-screen flex justify-center py-10 px-20">
              ...
              {step === 1 && (
                ...
                <div className="space-y-7">
                  ...
                  <div className="border border-gray-300 p-8 rounded-lg space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-6 h-23">
                      <div>
                        <Field
                          name="entityType"
              ...
              {step === 2 && (
                <>
                  ...
                  <div className="flex justify-between items-center">
                    <button
                      type="button"
                      className="btn-secondary h-10 min-w-23 rounded-lg"
                      onClick={() => setStep(1)}
                    >
                      Back
                    </button>
                    ...
                    `}
                    >
                      {/* Gradient curtain (disabled while loading) */}
                      {!isSubmitting && (
                        <span
                          className={`
                        absolute inset-0
                      ...
                      <span
                        ...
                        transition-all duration-300
                        ${!isSubmitting ? "group-hover:text-white group-hover:scale-105" : ""}
                      `}
                      >
                        {isSubmitting ? (
                          <>
                            <span className="h-4 w-4 rounded-full border-2 border-gray-200 border-t-blue-800 animate-spin "></span>
                            Sending...
                          </>
                        ) : (
                          <>
                            Send <GoArrowUpRight className="text-lg" />
                          </>
                        )}
                      </span>
                    </button>
