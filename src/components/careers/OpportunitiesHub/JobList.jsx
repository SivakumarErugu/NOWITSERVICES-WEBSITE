      ...
      <div className='w-full flex gap-x-4'>
        {jobSections.map((section, i) => (
          <button
            ...
            className={`px-8 py-2 rounded-md uppercase font-medium transition-all
              ${selectedSection === section.name
                ? 'bg-green-600 text-white'
                : 'border-2 border-[#0A66C2B2] bg-white hover:bg-gray-200 text-gray-700'
              }`}
          >
            {section.label}
          </button>
          ...
          .map((job, idx) => (
            ...
            >
              ...
              <div className="mt-auto flex justify-end">
                <button className="group relative overflow-hidden px-4 py-2 bg-white text-[#252525DE] rounded-md font-medium flex items-center gap-x-2">
      ...
      {visibleJobs < fullyFilteredJobs.length && (
        <div className="flex justify-center mt-8">
          <button
            ...
            className="group relative overflow-hidden w-70 px-4 py-2 bg-[#55B233] text-white rounded-md flex items-center justify-center gap-x-2"
          >
