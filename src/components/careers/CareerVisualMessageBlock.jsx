      ...
      {isReady && <>
        <div className="w-full max-w-5xl text-center ibmPlex-text font-semibold leading-tight">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-3 md:gap-x-4 gap-y-3 
            ...
            <span className="text-career-gradient">{t("carrerVisualBlock.line1.title")||"Calling"}</span>
            <Image
              src={careerCall1}
              alt="Career Callout"
              className="rounded-full object-cover h-10 w-20 sm:h-12 sm:w-28 md:h-16 md:w-44"
            />
            <span className="text-career-gradient">{t("carrerVisualBlock.line1.span")||"all"}</span>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-3 md:gap-x-4 gap-y-3 mt-4
            ...
            />
            <span className="text-career-gradient">{t("carrerVisualBlock.line2.title2")||"innovators"}</span>
          </div>

          {/* Line 3 */}
          <div className="flex flex-wrap items-center justify-center gap-x-3 md:gap-x-4 gap-y-3 mt-4
                        text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
            <span className="text-career-gradient">{t("carrerVisualBlock.line3.title")||"Ready to"}</span>
            <Image
              src={careerCall3}
              alt="Career Callout"
              className="rounded-full object-cover h-12 w-20 sm:h-14 sm:w-28 md:h-16 md:w-44"
            />
            <span className="text-career-gradient">{t("carrerVisualBlock.line3.span")||"Build"}</span>
          </div>

          {/* Line 4 */}
          <div className="flex flex-wrap items-center justify-center gap-x-3 md:gap-x-4 gap-y-3 mt-4
                        text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
            <span className="text-career-gradient">{t("carrerVisualBlock.line4.title")||"the Future"}</span>
            <Image
              src={careerCall4}
              alt="Career Callout"
        ...
        <p className="text-xs sm:text-sm md:text-base lg:text-lg text-center text-[#25252580] mt-8 md:mt-10 max-w-2xl">
          {t("carrerVisualBlock.description")||"We’re always looking for talented individuals who are passionate about technology, innovation, and creating meaningful impact. Join a team where your ideas matter and your growth is supported."}
        </p>
        ...
        <div className="mt-10 flex justify-center">
          <div className="relative inline-block">
            ...
            <ThemeLinkTag
              ...
              BtnText={t("carrerVisualBlock.BtnText")||"View Open Roles"}
