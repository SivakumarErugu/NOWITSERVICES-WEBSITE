      ...
      "
        ...
        >
            ...
            <div className="relative z-10">
                ...
                {/* Interactive Area */}
                <div className="relative w-full max-w-7xl mx-auto h-72 md:h-100 lg:h-120 group overflow-visible">
            ...
            "
              ...
              "
                    ...
                    <div className="absolute inset-0 flex items-end justify-center pb-4 md:pb-10 gap-x-8 px-2">
                        ...
                        {/* Product 1 */}
                        <div
                            className="hidden md:block w-32 h-48 lg:w-40 lg:h-56 rounded-2xl shadow-md overflow-hidden -mr-4 lg:-mr-6"
                            style={{ transform: "perspective(200px) rotateY(22deg) scale(0.9)" }}
                        >
                            <Image src={Product1} alt="Product 1" className="w-full h-full object-cover rounded-xl" />
                        </div>
              ...
              "
                ...
                `,
                        ...
                        >
                            <Image src={Product2} alt="Product 2" className="w-full h-full object-cover rounded-2xl" />
                        </div>
              ...
              "
                        >
                            <Image src={Product3} alt="Product 3" className="w-full h-full object-cover rounded-2xl" />
                        </div>
              ...
              "
                ...
                `,
                        ...
                        >
                            <Image src={Product4} alt="Product 4" className="w-full h-full object-cover rounded-2xl" />
                        </div>

                        {/* Product 5 */}
                        <div
                            className="hidden md:block w-32 h-48 lg:w-40 lg:h-56 rounded-2xl shadow-md overflow-hidden -ml-4 lg:-ml-6"
                            style={{ transform: "perspective(200px) rotateY(-22deg) scale(0.9)" }}
                        >
                            <Image src={Product5} alt="Product 5" className="w-full h-full object-cover rounded-xl" />
                        </div>
