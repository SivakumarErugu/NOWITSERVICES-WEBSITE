    ...
    return (
        <div className="w-full">
            ...
            <div className="hidden md:grid lg:hidden grid-cols-2 gap-4 max-w-3xl mx-auto mt-12">
                <Card>{t("banner.100")} {t("banner.quality")}</Card>
                <Card>{t("banner.24")} {t("banner.support")}</Card>
                <Card>{t("banner.onTime")}</Card>
                <Card>{t("banner.customer")} {t("banner.recommend")}</Card>
                <Card>{t("banner.projects")}</Card>
                <Card>{t("banner.industrial")} {t("banner.experience")}</Card>
            </div>
            {/* MOBILE */}
            <div className="grid md:hidden grid-cols-2 gap-4 max-w-sm mx-auto mt-10">
                <Card width="170">{t("banner.100")} {t("banner.quality")}</Card>
                <Card width="170">{t("banner.24")} {t("banner.support")}</Card>
                <Card width="170">{t("banner.onTime")}</Card>
                <Card width="170">{t("banner.customer")} {t("banner.recommend")}</Card>
                <Card width="170">{t("banner.projects")}</Card>
                <Card width="170">{t("banner.industrial")} {t("banner.experience")}</Card>
            </div>
        </div>
    );
};
